...
if(rawtitle!=null){ //if a title is selected, perform actions
    ...
    setTimeout(() => {
        ...
        ratingDiv.setAttribute("style", "text-align:center");
        ratingDiv.setAttribute("style", "float:right");

        //Create IMDB large text node
        var textnodeLarge = document.createElement("span");
        textnodeLarge.setAttribute("style", "font-size:20px");
